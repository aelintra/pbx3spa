...
export const ADVANCED_KEYS = [
  ...
  'localarea', 'localdplan', 'lterm', 'maxin', 'operator',
  'pickupgroup', 'play_beep', 'play_busy', 'play_congested', 'play_transfer',
  'rec_age', 'rec_final_dest', 'rec_file_dlim', 'rec_grace', 'rec_limit',
  'recmaxage', 'recmaxsize', 'recused', 'ringdelay', 'spy_pass', 'sysop', 'syspass',
