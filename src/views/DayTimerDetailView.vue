      ...
      <div class="detail-content">
        ...
        <form class="edit-form" @submit="saveEdit">
          ...
          <div class="form-fields">
            <FormReadonly v-if="daytimer.pkey != null" id="edit-pkey" label="pkey" :value="String(daytimer.pkey)" class="readonly-identity" />
            <template v-if="daytimer.shortuid != null && daytimer.shortuid !== ''">
              <FormReadonly v-if="isReadOnly('shortuid')" id="edit-shortuid" label="Local UID" :value="daytimer.shortuid" class="readonly-identity" />
            </template>
