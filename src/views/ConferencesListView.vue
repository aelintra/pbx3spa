...
<template>
  <div class="list-view">
    <header class="list-header">
      ...
      <p class="toolbar">
        ...
        <button
          type="button"
          class="export-btn"
          :disabled="sortedConferences.length === 0"
          @click="doExportCsv"
        >
          Export CSV
        </button>
        <button
          type="button"
          class="export-btn"
          :disabled="sortedConferences.length === 0 || exportPdfLoading"
          @click="doExportPdf"
        >
    ...
    <section v-else class="list-body">
      <p v-if="filterText && filteredConferences.length === 0" class="empty">
        No conferences match the filter.
      </p>
        ...
        <tbody>
          ...
          >
            ...
            <td>
              <router-link
                v-if="c.shortuid"
                :to="{ name: 'conference-detail', params: { shortuid: c.shortuid } }"
    ...
    >
      <template #body>
        <p>
          Conference room <strong>{{ confirmDeletePkey }}</strong> will be permanently deleted. This
          cannot be undone.
        </p>
      </template>
    </DeleteConfirmModal>
