...
| **WSS line test (in-admin)** | **`WSS_LINE_TEST_REQUIREMENTS.md`** (**JsSIP** + post-call report; lab green 2026-08-03) · **pbx3** `WEBRTC_WSS_LAB.md` § Fleet edge W1 · §6.1 | **Phase 1 done** — **Line test** on **WebRTC extension detail**. **Phase 2 (parked):** support panel + hidden tenant WebRTC caller → dial any ext — §10. |
