...
**Generated:** 2026-08-26 · **Script:** `scripts/list-empty-help-htext.mjs`
...
| Metric | Count |
|--------|------:|
| Empty htext rows in seed (all) | **1** |
| Wired in SPA (any panel) | 1 |
| In this list | **1** |
...
|------|------|-------------|--------------|------------------|
| [ ] | `ext_len` | Extensions length | yes | Tenants → Create (`/tenants/new`)<br>Tenants → Edit (`/tenants/:pkey`) |
